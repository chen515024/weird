export const parseObject = {
  en: {
    output: "Output", //输出文本
    answer: "You answered", //用户回答文本:[],
    successMsg: "You got it right!", //用户回答正确文本
    errorMsg: "You answered incorrectly.", //用户回答错误文本
    detail: [
      `
...
***-0 + 1 * 0 - 0; // -> 0***
  ...
  zh: {
    output: "输出", //输出文本
    answer: "你的回答", //用户回答文本:[],
    successMsg: "回答正确", //用户回答正确文本
    errorMsg: "回答错误", //用户回答错误文本
    detail: [
      `
...
export function getCurrentQuestions(
  ...
  const text = {
    en: `Question ${order} of ${total}`,
    zh: `第${order}题，共${total}题`,
  };
...
export function getCurrentAnswers(
  ...
  const text = {
    en: `You got ${correctNum} out of ${total} correct!`,
    zh: `共 ${total} 道题，您答对了 ${correctNum} 道题!`,
  };
...
export const questions = [
  {
    question: "true + false",
    answer: ['"truefalse"', "1", "NaN", "SyntaxError"],
    correct: "1",
  },
  {
    question: "[,,,].length",
    answer: ["0", "3", "4", "SyntaxError"],
    correct: "3",
  },
  {
    question: "[1, 2, 3] + [4, 5, 6]",
    answer: ['"123456"', '"1,2,34,5,6"', '"1,2,3,4,5,6"', "NaN"],
    correct: '"1,2,34,5,6"',
  },
  {
  ...
  {
    question: '!!""',
    answer: ["true", "false", "undefined", "SyntaxError"],
    correct: "false",
  },
  {
    question: "+!![]",
    answer: ["true", "false", "0", "1"],
    correct: "1",
  },
  {
    question: "!!!true",
    answer: ["true", "false", "0", "SyntaxError"],
    correct: "false",
  },
  {
    question: 'true === "true"',
  ...
  {
    question: '""- - ""',
    answer: ['""', "0", "NaN", "SyntaxError"],
    correct: "0",
  },
  {
    question: "null + 0",
    answer: ["0", '"null0"', "NaN", "TypeError"],
    correct: "0",
  },
  {
    question: "0/0",
    answer: ["0", "Infinity", "NaN", "SyntaxError"],
    correct: "NaN",
  },
  {
  ...
  {
    question: "true++",
    answer: ["2", "undefined", "NaN", "SyntaxError"],
    correct: "SyntaxError",
  },
  {
    question: '"" - 1',
  ...
  {
    question: '(null - 0) + "0"',
    answer: ['"null0"', '"00"', "0", "NaN"],
    correct: '"00"',
  },
  {
    question: 'true + ("true" - 0)',
    answer: ["1", "2", "NaN", "SyntaxError"],
    correct: "NaN",
  },
  {
    question: "!5 + !5",
  ...
  {
    question: "NaN === NaN",
    answer: ["true", "false", "TypeError", "SyntaxError"],
    correct: "false",
  },
  {
    question: "NaN++",
    answer: ["NaN", "undefined", "TypeError", "SyntaxError"],
    correct: "NaN",
  },
  {
    question: "undefined + false",
    answer: ['"undefinedfalse"', "0", "NaN", "SyntaxError"],
    correct: "NaN",
  },
  {
    question: "+0 === -0",
